...
In 2010, I was an undergraduate researcher in the lab of [<span style="color:green">Dr. Ashraf Ismail</span>](http://www.mcgill.ca/foodscience/staff-and-research/ashraf-ismail),who is the co-director of the [<span style="color:green">McGill IR Group</span>](http://www.mcgill.ca/foodscience/mcgill-ir-group), whose work revolves around the investigation of food systems at the molecular level. I helped PhD Candidate Diana Valtierra Rodriguez analyze a cookie model system containing high levels of &beta;-lactoglobulin and &alpha;-lactalbumin using Attenuated Total Reflectance-Fourier Transform Infrared (ATR-FTIR) spectroscopy. ATR-FTIR spectroscopy allows for the analysis of solid samples with minimal preparation, making it an ideal technique for analyzing complex systems like a dough. 

I prepared a cookie dough model systems with varying amounts of &beta;-lactoglobulin, &alpha;-lactalbumin, and glycomacropeptide and analyzed the dough material as well as the baked cookie using ATR-FTIR spectroscopy.  
