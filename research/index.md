...
While PL is already being used commercially to sterilize food contact surfaces such as bottle caps, it is not yet used directly on food products. The FDA has approved its general use since 1996, but its effeciveness will vary from one commodity to another. This is why it is important to test how different process parameters and treatment conditions affect PL effectiveness for microbial on cheese surface, specifically. Of particular interest are questions such as:  
